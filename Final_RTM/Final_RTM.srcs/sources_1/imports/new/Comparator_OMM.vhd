...
architecture Behavioral of Comparator_OMM is
        ...
        if clk_s'event and clk_s = '1' then
            if reset = '1' then
                ...
                -- Normal operation after first edges_done
                    ...
                    -- Convert q_str_omm to integer for comparison
                    if to_integer(unsigned(q_str_omm)) < y_moins or to_integer(unsigned(q_str_omm)) > y_plus then   -- If q_str_omm is outside the interval
