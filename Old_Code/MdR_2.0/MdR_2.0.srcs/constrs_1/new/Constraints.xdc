...
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets RO_D_UUT/Inverters[*]]
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets RO_D_UUT/Nand_out]

# Clock signal
set_property PACKAGE_PIN W5 [get_ports ro_out]							
	set_property IOSTANDARD LVCMOS33 [get_ports ro_out]
	create_clock -add -name sys_clk_pin -period 33.3 -waveform {0 16.65} [get_ports ro_out]
...
set_property PACKAGE_PIN V13 [get_ports {q_str[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {q_str[7]}]
