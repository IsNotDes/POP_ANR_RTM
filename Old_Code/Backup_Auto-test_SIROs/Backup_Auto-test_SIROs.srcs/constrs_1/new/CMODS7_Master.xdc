...
set_property PACKAGE_PIN D1 [get_ports Enable]  ;# Pin B11 (IO_L1P_T0_D00_MOSI_14) for Enable
set_property IOSTANDARD LVCMOS33 [get_ports Enable]

# Map EnableROattack to a switch (updated pin assignment)
set_property PACKAGE_PIN D2 [get_ports EnableROattack]  ;# Pin D3 (IO_L1P_T0_34) for EnableROattack
set_property IOSTANDARD LVCMOS33 [get_ports EnableROattack]

# Map ROattack_dummy_out to a pin (adapted for Spartan 7 pinout)
set_property PACKAGE_PIN E2 [get_ports ROattack_dummy_out]  ;# Pin F3 (IO_L8P_T1_34) for ROattack_dummy_out
