...
entity Detector is
    Port (
        ...
        q_str_d        : out STD_LOGIC_VECTOR(4 downto 0);    -- Stored value output
...
architecture Behavioral of Detector is
    -- Internal signals
    signal q_cnt             : STD_LOGIC_VECTOR(4 downto 0);
    signal q_fe              : STD_LOGIC;
    signal q_str_d_internal  : STD_LOGIC_VECTOR(4 downto 0);
    signal x_moins_internal  : STD_LOGIC_VECTOR(4 downto 0);
    signal x_plus_internal   : STD_LOGIC_VECTOR(4 downto 0);
    ...
    component Counter_Detector
        Port (
            ...
            q_cnt     : out STD_LOGIC_VECTOR(4 downto 0)
        );
    end component;
    ...
    component Storing_Detector
        Port (
            ...
            reset     : in  STD_LOGIC;
            q_fe      : in  STD_LOGIC;
            q_cnt     : in  STD_LOGIC_VECTOR(4 downto 0);
            q_str_d   : out STD_LOGIC_VECTOR(4 downto 0)
        );
    end component;
    ...
    component Comparator_Detector
        Port (
            ...
            x_moins_out    : out STD_LOGIC_VECTOR(4 downto 0);
            x_plus_out     : out STD_LOGIC_VECTOR(4 downto 0)
        );
    end component;
