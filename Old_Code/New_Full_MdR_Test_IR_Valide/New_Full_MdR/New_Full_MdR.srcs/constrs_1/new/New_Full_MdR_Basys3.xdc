...
##Sch name = JB4
set_property PACKAGE_PIN B16 [get_ports {edge_count[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {edge_count[2]}]
##Sch name = JB7
set_property PACKAGE_PIN A15 [get_ports {edge_count[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {edge_count[1]}]
##Sch name = JB8
set_property PACKAGE_PIN A17 [get_ports {edge_count[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {edge_count[0]}]
##Sch name = JB9
set_property PACKAGE_PIN C15 [get_ports edges_done]					
