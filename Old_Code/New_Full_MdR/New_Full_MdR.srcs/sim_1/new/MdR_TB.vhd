...
architecture Behavioral of MdR_TB is
    ...
    component MdR
        Port (
            ...
            q_str_d     : out STD_LOGIC_VECTOR(6 downto 0);         -- Stored value from Detector (modified to 6 downto 0)
            q_str_atm   : out STD_LOGIC_VECTOR(6 downto 0);         -- Stored value from Auto_Test_Module (modified to 6 downto 0)
    ...
    signal Alarme      : STD_LOGIC;                     -- Alarm output from Detector
    signal Final_Alarm : STD_LOGIC;                     -- Final alarm output from Auto_Test_Module
    signal q_str_d     : STD_LOGIC_VECTOR(6 downto 0);  -- Stored value from Detector
    signal q_str_atm   : STD_LOGIC_VECTOR(6 downto 0);  -- Stored value from Auto_Test_Module
    ...
    signal x_moins_tb  : STD_LOGIC_VECTOR(6 downto 0);
    signal x_plus_tb   : STD_LOGIC_VECTOR(6 downto 0);
