...
set_property PACKAGE_PIN U19 [get_ports {q_str_d[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {q_str_d[6]}]
set_property PACKAGE_PIN V19 [get_ports {q_str_d[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {q_str_d[5]}]
set_property PACKAGE_PIN W18 [get_ports {q_str_d[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {q_str_d[4]}]
set_property PACKAGE_PIN U15 [get_ports {q_str_d[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {q_str_d[3]}]
set_property PACKAGE_PIN U14 [get_ports {q_str_d[2]}]					
...
set_property PACKAGE_PIN V13 [get_ports {q_str_d[0]}]					
...
#Pmod Header JXADC
#Sch name = XA1_P
set_property PACKAGE_PIN J3 [get_ports {x_moins_out[6]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {x_moins_out[6]}]
#Sch name = XA2_P
set_property PACKAGE_PIN L3 [get_ports {x_moins_out[5]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {x_moins_out[5]}]
#Sch name = XA3_P
set_property PACKAGE_PIN M2 [get_ports {x_moins_out[4]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {x_moins_out[4]}]
#Sch name = XA4_P
set_property PACKAGE_PIN N2 [get_ports {x_moins_out[3]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {x_moins_out[3]}]
#Sch name = XA1_N
set_property PACKAGE_PIN K3 [get_ports {x_moins_out[2]}]				
...
##VGA Connector
set_property PACKAGE_PIN G19 [get_ports {x_plus_out[6]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {x_plus_out[6]}]
set_property PACKAGE_PIN H19 [get_ports {x_plus_out[5]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {x_plus_out[5]}]
set_property PACKAGE_PIN J19 [get_ports {x_plus_out[4]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {x_plus_out[4]}]
set_property PACKAGE_PIN N19 [get_ports {x_plus_out[3]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {x_plus_out[3]}]
set_property PACKAGE_PIN N18 [get_ports {x_plus_out[2]}]				
