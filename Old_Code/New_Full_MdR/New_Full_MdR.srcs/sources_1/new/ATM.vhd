...
architecture Behavioral of ATM is
    ...
    signal q_str_atm_internal  : STD_LOGIC_VECTOR(6 downto 0); -- Counter output (modified to 6 downto 0)
    ...
    component Counter_ATM
        Port (
            ...
            q_str_atm     : out STD_LOGIC_VECTOR(6 downto 0)   -- Counter output
        );
    end component;
    ...
    component Comparator_ATM
        Port (
            ...
            q_str_atm      : in  STD_LOGIC_VECTOR(6 downto 0);   -- Input count value
