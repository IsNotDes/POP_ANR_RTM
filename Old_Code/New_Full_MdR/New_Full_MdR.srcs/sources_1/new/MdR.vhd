...
architecture Behavioral of MdR is
    ...
    component ATM
        Port (
            ...
            q_str_atm       : out STD_LOGIC_VECTOR(6 downto 0);   -- Stored value output (modified to 6 downto 0)
...
begin
    ...
    ATM_UUT: ATM
        port map (
            ...
            q_str_atm       => q_str_atm,         -- Stored value output (modified to 6 downto 0)
            edge_count  => edge_count,     -- Edge count output
            edges_done  => edges_done,      -- Signal indicating counting is done
            y_moins_out => y_moins_out,
            y_plus_out => y_plus_out
        );
