...
architecture Behavioral of MdR_TB is
    ...
    constant STEP_PERCENT     : real := 2.0;                            -- Step size in percentage
    constant N                : integer := 5;                           -- Number of clk_s periods for one cycle of counting for ATM
    constant NUM_STEPS        : integer := 25;                          -- Number of steps in each direction
    ...
    begin
        ...
        for i in -NUM_STEPS to NUM_STEPS loop
            ...
            for j in -NUM_STEPS to NUM_STEPS loop
                ...
                stable_time := 15 * N * CLK_S_BASE;
                wait for stable_time;
                
                -- Write results to file
                write(line_out, clk_s_period_current);
                write(line_out, string'(","));
                write(line_out, gbf_period_current);
                write(line_out, string'(","));
