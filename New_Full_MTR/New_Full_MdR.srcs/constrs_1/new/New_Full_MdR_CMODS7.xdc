...
create_clock -add -name clk_s -period 1538.46 -waveform {0 769.23} [get_ports clk_s_IBUF] # 1538.46 ns period
create_clock -add -name ro_out -period 38.46 -waveform {0 19.23} [get_ports ro_out] # 38.46 ns period
